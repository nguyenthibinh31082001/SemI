<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewOrdesBroadBand.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="Add New Ordes Broad Band Connection" 
                            ...
                            <td align="center">
                                ...
                                <asp:GridView ID="gvDialup" runat="server" AllowPaging="True" CellPadding="4" 
                                    ...
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:ImageButton ID="ibtupdate0" runat="server" 
                                                    CommandArgument='<%#Eval("OrderID") %>' Height="16px" 
                                                    ImageUrl="~/images/view.png" onclick="ibtupdate0_Click" Width="61px" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                               ...
                               <tr>
                                    ...
                                    <tr>
                                        <td align="right" class="style17">
                                            &nbsp;</td>
                                        <td align="right" class="style8">
                                            Broad Band Connection</td>
                                        <td style="text-align: left">
                                            <asp:DropDownList ID="BBLL1" runat="server" Height="16px" 
...
&nbsp;
                                  ...
                                  <table ID="table6" runat="server" align="center" border="0" 
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" class="style8">
                                            OrderId</td>
                                        <td style="text-align: left">
                                            <asp:TextBox ID="txtorderid" runat="server" Width="179px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right" class="style18">
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ibtdate" runat="server" Height="19px" 
                                                ImageUrl="~/images/Calendar.png" onclick="ibtdate_Click" Width="21px" />
                                    ...
                                    <tr>
                                        ...
                                        <td align="right" class="style12">
                                            Broad Band Connection</td>
                                        <td style="text-align: left" class="style22">
                                            <asp:DropDownList ID="BBID" runat="server" Height="16px" Width="217px">
                                            </asp:DropDownList>
                                        </td>
                                    </tr>
                                        <tr>
                    ...
                    <tr>
                    <td ID="td1">
                    <asp:Label ID="datetimeEX" runat="server"></asp:Label>
                       </td>            
                    </tr>
                    </table>
