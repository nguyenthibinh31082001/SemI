<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewOrdersLandLine.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="Add New Order Land Line Connection" 
                               ...
                               <tr>
                                    ...
                                    <tr>
                                        <td align="right" class="style17">
                                            &nbsp;</td>
                                        <td align="right" class="style8">
                                            Land Line Connection</td>
                                        <td style="text-align: left">
                                            <asp:DropDownList ID="LLID1" runat="server" Height="16px" 
                                  ...
                                  <table ID="table6" runat="server" align="center" border="0" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ibtdate" runat="server" ImageUrl="~/images/Calendar.png" 
                                                onclick="ibtdate_Click" />
                                    ...
                                    <tr>
                                     ...
                                     <tr>
                                        ...
                                        <td align="right" class="style12">
                                            Land Line Connection</td>
                                        <td style="text-align: left" class="style22">
                                            <asp:DropDownList ID="LLID" runat="server" Height="16px" Width="216px">
                                            </asp:DropDownList>
                                            </td>
                                    </tr>
                                        <tr>
