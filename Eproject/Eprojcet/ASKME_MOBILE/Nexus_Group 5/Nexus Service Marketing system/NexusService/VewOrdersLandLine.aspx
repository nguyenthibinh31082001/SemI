<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="VewOrdersLandLine.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
                                  ...
                                  <table ID="table6" runat="server" align="center" border="0" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ate" runat="server" Height="23px" 
                                                ImageUrl="~/images/Calendar.png" onclick="ate_Click" Width="18px" />
