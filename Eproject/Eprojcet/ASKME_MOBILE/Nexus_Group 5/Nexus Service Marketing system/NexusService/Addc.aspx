<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="Addc.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Add New Dialup Connection" 
                    ...
                    <table align="center" class="style2">
                        <tr>
                            <td align="center">
                                <br />
                                Registered Phone Number: <asp:TextBox ID="txttim" runat="server" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:Calendar ID="cldorder" runat="server" 
                                                onselectionchanged="cldorder_SelectionChanged"></asp:Calendar>
