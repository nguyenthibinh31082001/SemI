<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewOrdersEquypment.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
    <asp:Panel ID="Panel1" runat="server" GroupingText="Add New Order Equypment Connection" 
                        ...
                        <tr>
                            <td align="center">
                                ...
                                <asp:GridView ID="gvDialup" runat="server" AllowPaging="True" CellPadding="4" 
                                    ...
                                    onselectedindexchanged="gvDialup_SelectedIndexChanged1">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ibtdate" runat="server" Height="19px" 
                                                ImageUrl="~/images/Calendar.png" onclick="ibtdate_Click" Width="22px" />
