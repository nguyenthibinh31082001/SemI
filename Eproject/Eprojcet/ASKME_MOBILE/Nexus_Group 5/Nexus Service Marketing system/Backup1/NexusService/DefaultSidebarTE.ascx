<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DefaultSidebarTE.ascx.cs" Inherits="Sidebar1" %>
<%@ Import Namespace="Artisteer" %>
<%@ Register TagPrefix="artisteer" Namespace="Artisteer" %>
<%@ Register TagPrefix="art" TagName="DefaultVerticalMenu" Src="DefaultVerticalMenu.ascx" %>

<%@ Register src="DefaultVerticalMenuTE.ascx" tagname="DefaultVerticalMenuTE" tagprefix="uc1" %>
<uc1:DefaultVerticalMenuTE ID="DefaultVerticalMenuTE1" runat="server" />
