<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="VewOrdesBroadBand.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
                                  ...
                                  <table ID="table6" runat="server" align="center" border="0" 
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ibtdate" runat="server" Height="21px" 
                                                ImageUrl="~/images/Calendar.png" onclick="ibtdate_Click" Width="23px" />
