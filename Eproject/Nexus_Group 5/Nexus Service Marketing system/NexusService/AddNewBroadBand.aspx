<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewBroadBand.aspx.cs" Inherits="NotAccess" Title="Untitled Page" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="SheetContentPlaceHolder" Runat="Server">
    <p class="style1">
        <br />
                ...
                <asp:Panel ID="Panel1" runat="server" GroupingText="BroadBand Connection" 
                    HorizontalAlign="Center" style="text-align: center">
                    <table align="center" class="style2">
                        <tr>
                            <td align="center">
                                <asp:GridView ID="gvDialup"  runat="server"  
                        CellPadding="4"  ForeColor="#333333" 
                        PageSize="6" Width="522px">
                                        <Columns>
                                    <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:ImageButton ID="ibtupdate0" runat="server" ImageUrl="~/images/view.png"
                                            Width="61px" Height="16px" onclick="ibtupdate0_Click" CommandArgument='<%#Eval("BroadBandID") %>' />
