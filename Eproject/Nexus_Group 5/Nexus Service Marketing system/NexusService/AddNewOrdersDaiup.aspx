<%@ Page Language="C#" MasterPageFile="~/design/MasterPage.master" AutoEventWireup="true" CodeFile="AddNewOrdersDaiup.aspx.cs" Inherits="ViewOrders" Title="Untitled Page" %>
                                    ...
                                    <tr>
                                        ...
                                        <td class="style13" style="text-align: left">
                                            ...
                                            <asp:ImageButton ID="ibtdate" runat="server" Height="24px" 
                                                ImageUrl="~/images/Calendar.png" onclick="ibtdate_Click" Width="20px" />
